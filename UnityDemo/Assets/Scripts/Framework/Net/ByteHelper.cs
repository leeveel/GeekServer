...
public static class ByteHelper
{
    ...
    {
        BinaryPrimitives.WriteUInt32BigEndian(bytes.AsSpan().Slice(offset), num);
    }

    public static void Write(this byte[] bytes, int num, int offset)
    {
        BinaryPrimitives.WriteInt32BigEndian(bytes.AsSpan().Slice(offset), num);
    }
    ...
    {
        BinaryPrimitives.WriteUInt16BigEndian(bytes.AsSpan().Slice(offset), num);
    }

    public static void Write(this byte[] bytes, long num, int offset)
    {
        BinaryPrimitives.WriteInt64BigEndian(bytes.AsSpan().Slice(offset), num);
    }

    public static int ReadInt(this byte[] bytes, int offset)
    {
        return BinaryPrimitives.ReadInt32BigEndian(bytes.AsSpan().Slice(offset));
    }

    public static long ReadLong(this byte[] bytes, int offset)
    {
        return BinaryPrimitives.ReadInt64BigEndian(bytes.AsSpan().Slice(offset));
    }
    ...
    {
        return BinaryPrimitives.ReadInt64BigEndian(bytes.Slice(offset));
    }
    ...
    public static void Write(this Span<byte> buffer, long value, ref int offset)
    {
        ...
        BinaryPrimitives.WriteInt64BigEndian(buffer.Slice(offset), value);
        offset += LongSize;
    }
    ...
    public static void Write(this Span<byte> buffer, TempNetPackage package, ref int offset)
    {
        ...
        {
            package.body.CopyTo(buffer.Slice(offset));
        }
    }
