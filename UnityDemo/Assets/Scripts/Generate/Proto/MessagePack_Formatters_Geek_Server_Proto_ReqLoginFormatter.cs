...
namespace MessagePack.Formatters.Geek.Server.Proto
{
    public sealed class ReqLoginFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Geek.Server.Proto.ReqLogin>
    {
        ...
        // Sign
        private static global::System.ReadOnlySpan<byte> GetSpan_Sign() => new byte[1 + 4] { 164, 83, 105, 103, 110 };
        // UniId
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Geek.Server.Proto.ReqLogin value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            writer.WriteRaw(GetSpan_Sign());
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<string>(formatterResolver).Serialize(ref writer, value.Sign, options);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 6:
                        ...
                        continue;
                    case 4:
                        if (global::MessagePack.Internal.AutomataKeyGen.GetKey(ref stringKey) != 1852270931UL) { goto FAIL; }

                        ____result.Sign = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<string>(formatterResolver).Deserialize(ref reader, options);
                        continue;
                    case 5:
