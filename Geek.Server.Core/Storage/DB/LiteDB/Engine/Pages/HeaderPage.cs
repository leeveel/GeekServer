    ...
    internal class HeaderPage : BasePage
    {
        ...
        private void LoadPage()
        {
            ...
            using (var r = new BufferReader(new[] { area }, false))
            {
                ...
                if(len>0)
                { 
                    var datas = r.ReadBytes(len);
                    _collections = BsonSerializer.Deserialize(datas, true);
                }else
                {
                    _collections = new BsonDocument();
                }
        ...
        public override PageBuffer UpdateBuffer()
        {
            ...
            if (_isCollectionsChanged)
            {
                ...
                using (var w = new BufferWriter(area))
                {
                    ...
                    var bytes = BsonSerializer.Serialize(_collections, true);
        ...
        int GetCollectionsBytesCount()
        {
            return BsonSerializer.Serialize(_collections, true).Length + 8;
        }
